...
- % python3 ./api_proof_of_concept.py
'''
...
POC_BARCODES_SOURCE = os.environ['ANXEODALERTS_POC_BARCODES_SOURCE_FILEPATH']
POC_OUTPUT = os.environ['ANXEODALERTS_POC_BARCODES_OUTPUT_FILEPATH']
